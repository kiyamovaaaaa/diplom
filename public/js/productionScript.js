...
function rQGetProduction() {
  ...
  xhttp.open("GET", encodeURI( HOST_URL + "getProduction" ));
  // xhttp.setRequestHeader("Authorization", "Bearer " + userToken);
  xhttp.send();
}
...
function vVCreateTable(){
  let _objItems = ObjProductionTable;
  console.log(ObjProductionTable);
